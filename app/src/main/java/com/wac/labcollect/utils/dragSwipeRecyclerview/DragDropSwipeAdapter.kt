package com.wac.labcollect.utils.dragSwipeRecyclerview
...
import com.wac.labcollect.utils.dragSwipeRecyclerview.DragDropSwipeRecyclerView.ListOrientation.DirectionFlag
import com.wac.labcollect.utils.dragSwipeRecyclerview.listener.OnItemDragListener
import com.wac.labcollect.utils.dragSwipeRecyclerview.listener.OnItemSwipeListener
import com.wac.labcollect.utils.dragSwipeRecyclerview.util.DragDropSwipeDiffCallback
import com.wac.labcollect.utils.dragSwipeRecyclerview.util.DragDropSwipeTouchHelper
import com.wac.labcollect.utils.dragSwipeRecyclerview.util.drawHorizontalDividers
import com.wac.labcollect.utils.dragSwipeRecyclerview.util.drawVerticalDividers
...
abstract class DragDropSwipeAdapter<T, U : DragDropSwipeAdapter.ViewHolder>(
    ...
    var mutableDataSet: MutableList<T> = dataSet.toMutableList()
    var dataSet: List<T>
        get() = mutableDataSet
        set(value) {
